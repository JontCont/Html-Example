<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Store7.aspx.vb" Inherits="WebApplication1.Store7" %>
                                 ...
                                 <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                       ...
                                       <div class="carousel-inner">
                                              <div class="item active">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/218620/ss_2799a1fde932e739138de91f0910ada013ddfca3.1920x1080.jpg?t=1557419544" alt="Los Angeles" style="width:100%;"/>
                                              </div>

                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/218620/ss_b26f1852b68ab0af7fdd4932b1c9f78dc87a0325.1920x1080.jpg?t=1557419544" alt="Chicago" style="width:100%;"/>
                                              </div>
                                       
                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/218620/ss_01fdd60d88bc24f48f688b6624dc42ce493bd76a.1920x1080.jpg?t=1557419544" alt="New york" style="width:100%;"/>
                                              </div>
                                       </div>
                                  ...
                                  <div class="col-sm-5" style="left:5%;top:10px;">
                                      <img style="height:150px;" src="https://steamcdn-a.akamaihd.net/steam/apps/218620/header.jpg?t=1557419544"/>
                                      <p style="font-size:14px; width:85%;">
                                          PAYDAY 2 is an action-packed, 
                                          four-player co-op shooter that once again lets gamers don the masks of the original PAYDAY crew 
                                          - Dallas, Hoxton, Wolf and Chains - as they descend on Washington DC for an epic crime spree.</p>
                                      <p style="font-size:14px;"><br />&nbsp;發行日期:&nbsp;2013 年 8 月 13 日</p>
                                      <p style="font-size:14px;">&nbsp;發行商:&nbsp;Starbreeze Publishing AB</p>
                ...
                <div class="col-sm-4 col-xs-12" style="height:390px;">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"style="text-align:left;">
                      <p style="color:black;">名稱: PAYDAY 2</p>
                      <p style="color:black;">類型: 動作</p>
                      <p style="color:black;">開發人員: OVERKILL - a Starbreeze Studio.</p>
                      <p style="color:black;">發行商: Starbreeze Publishing AB</p>
                ...
                <div class="col-sm-4 col-xs-12" >
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body" style="text-align:left;">
                        ...
                        <p style="color:black;">2.處理器: 2.3 GHz Intel Quad Core Processor</p><br />
                        <p style="color:black;">3.記憶體: 8  GB 記憶體</p><br />
                        <p style="color:black;">4.儲存空間: 45 GB 可用空間</p><br />
                    </div>
                    <div class="panel-footer">
