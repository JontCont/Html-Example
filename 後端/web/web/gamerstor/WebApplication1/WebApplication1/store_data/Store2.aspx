<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Store2.aspx.vb" Inherits="WebApplication1.Store2" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Delight - Yakuza Kiwami 2</title>
            ...
            <div class="col-md-12">
                   <div class ="auto-style4">                     
                     <asp:Panel ID="Panel1" runat="server" style="position: relative; float: right; ">
                       <asp:Label ID="Viewname" runat="server" Text=""  ForeColor="White"></asp:Label>
                                 ...
                                 <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                       ...
                                       <div class="carousel-inner">
                                              <div class="item active">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/927380/ss_c90b9d21ee15ffaec35395e9f2bf72ffb135fbb0.1920x1080.jpg?t=1558022476" alt="Los Angeles" style="width:100%;"/>
                                              </div>

                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/927380/ss_fd144358f7aee2fc33c653896c9fc5d32ef4eec4.1920x1080.jpg?t=1558022476" alt="Chicago" style="width:100%;"/>
                                              </div>
                                       
                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/927380/ss_936b29163b51d69acdbebe7edff019dbe1bbde2d.1920x1080.jpg?t=1558022476" alt="New york" style="width:100%;"/>
                                              </div>
                                       </div>
                                  ...
                                  <div class="col-sm-5" style="left:5%;top:10px;">
                                      <img style="height:150px;" src="https://steamcdn-a.akamaihd.net/steam/apps/927380/header.jpg?t=1558022476"/>
                                      <p style="font-size:14px; width:85%;">
                                          在這次毫無保留的極道幫派宿命之戰中，「堂島之龍」桐生一馬必須面對野心勃勃的「關西之龍」鄉田龍司。
                                          身為系列作中深受玩家喜愛的一作，現以令人驚豔的4K畫質和解鎖幀率限制，再次重現於玩家眼前。
                                          雙龍激鬥，唯有一頭稱霸。</p>
                                      <p style="font-size:14px;"><br />&nbsp;發行日期:&nbsp;2019 年 5 月 9 日</p>
                                      <p style="font-size:14px;">&nbsp;發行商:&nbsp;SEGA</p>
              ...
              <div class="row slideanim">
                ...
                <div class="col-sm-4 col-xs-12" style="height:390px;">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"style="text-align:left;">
                      <p style="color:black;">名稱: Yakuza Kiwami 2</p>
                      <p style="color:black;">類型: 動作</p>
                      <p style="color:black;">開發人員: SEGA</p>
                      <p style="color:black;">發行商: SEGA </p>
                      <p style="color:black;">系列作: Yakuza</p>
                      <p style="color:black;">發行日期: 2019 年 5 月 9 日</p>
                    </div>
                ...
                <div class="col-sm-4 col-xs-12" >
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body" style="text-align:left;">
                        <p style="color:black;">1.作業系統: Windows 10 64-bit (32-bit not supported)</p>
                        <p style="color:black;">2.處理器: Intel Core i5-3470, 3.2 GHz / AMD Ryzen 3 1200, 3.1 GHz</p>
                        <p style="color:black;">3.記憶體: 4 GB 記憶體</p>
                        <p style="color:black;">4.儲存空間: 42 GB 可用空間</p>
                        <br />
                        <br />
                        <br />
                    </div>
                ...
                <div class="col-sm-4 col-xs-12" style="height:390px;">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body" style="text-align:left;">
                       <p style="color:black;">1.Intense Violence</p><br />
                       <p style="color:black;">2.Partial Nudity</p><br />
                       <p style="color:black;">3.Sexual Themes</p><br />
                       <p style="color:black;">4.Strong Language</p>
                        <br />
                    </div>
                      <div class="panel-footer">
