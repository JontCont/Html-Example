<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Store4.aspx.vb" Inherits="WebApplication1.Store4" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Delight - PLAYERUNKNOWN'S BATTLEGROUNDS</title>
                                 ...
                                 <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                       ...
                                       <div class="carousel-inner">
                                              <div class="item active">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/578080/ss_23af2e59855a833c22d0c11ca23a719f54a554ff.1920x1080.jpg?t=1556089957" alt="Los Angeles" style="width:100%;"/>
                                              </div>

                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/578080/ss_2c79b3b590b186b10bf082d37674621f204a3497.1920x1080.jpg?t=1556089957" alt="Chicago" style="width:100%;"/>
                                              </div>
                                       
                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/578080/ss_2aa1de6f978ae9eb6dbe8fcf061395677c0460ab.1920x1080.jpg?t=1556089957" alt="New york" style="width:100%;"/>
                                              </div>
                                       </div>
                                  ...
                                  <div class="col-sm-5" style="left:5%;top:10px;">
                                      <img style="height:150px;" src="https://steamcdn-a.akamaihd.net/steam/apps/578080/header.jpg?t=1556089957"/>
                ...
                <div class="col-sm-4 col-xs-12" style="height:390px;">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"style="text-align:left;">
                      <p style="color:black;">名稱: PLAYERUNKNOWN'S BATTLEGROUNDS</p>
                      <p style="color:black;">類型: 動作</p>
                      <p style="color:black;">開發人員: PUBG Corporations</p>
                      <p style="color:black;">發行商: PUBG Corporation</p>
                      <p style="color:black;">系列作: none</p>
                      <p style="color:black;">發行日期: 2017 年 12 月 21 日</p>
                    </div>
                ...
                <div class="col-sm-4 col-xs-12" >
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body" style="text-align:left;">
                        ...
                        <p style="color:black;">2.處理器: ntel Core i5-6600K / AMD Ryzen 5 1600</p><br />
                        <p style="color:black;">3.記憶體: 16 GB 記憶體</p><br />
                        <p style="color:black;">4.儲存空間: 30 GB 可用空間</p><br />
