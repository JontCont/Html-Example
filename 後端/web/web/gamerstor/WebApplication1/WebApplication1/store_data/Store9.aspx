<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Store9.aspx.vb" Inherits="WebApplication1.Store9" %>
                                 ...
                                 <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                       ...
                                       <div class="carousel-inner">
                                              <div class="item active">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/281990/ss_11579d673129e91f4d0dfa9c8392ef25326c40d8.1920x1080.jpg?t=1557839022" alt="Los Angeles" style="width:100%;"/>
                                              </div>

                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/281990/ss_b69c477395c4c5f06414699a799d21da4b9295ee.1920x1080.jpg?t=1557839022" alt="Chicago" style="width:100%;"/>
                                              </div>
                                       
                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/281990/ss_3ec7c189f50fb0bb6d8e92ae28daba6db23b484e.1920x1080.jpg?t=1557839022" alt="New york" style="width:100%;"/>
                                              </div>
                                       </div>
                                  ...
                                  <div class="col-sm-5" style="left:5%;top:10px;">
                                      <img style="height:150px;" src="https://steamcdn-a.akamaihd.net/steam/apps/281990/header.jpg?t=1557839022"/>
                                      <p style="font-size:14px; width:85%;">
                                          Explore and discover a spectacular and ever-changing universe! 
                                          Paradox Development Studio, makers of the Europa Universalis and Crusader Kings 
                                          series, and publishers of the best-selling Cities: Skylines, presents Stellaris,
                                          advancing the genre of grand strategy to the very edges of the universe. </p>
                                      <p style="font-size:14px;"><br />&nbsp;發行日期:&nbsp;2016 年 5 月 9 日</p>
                                      <p style="font-size:14px;">&nbsp;發行商:&nbsp;Paradox Interactive</p>
                ...
                <div class="col-sm-4 col-xs-12" style="height:390px;">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"style="text-align:left;">
                      <p style="color:black;">名稱: Stellaris</p>
                      <p style="color:black;">類型: 策略</p>
                      <p style="color:black;">開發人員: Paradox Development Studio</p>
                      <p style="color:black;">發行商: Paradox Interactive</p>
                      <p style="color:black;">系列作: Stellaris</p>
                      <p style="color:black;">發行日期: 2016 年 5 月 9 日</p>
                    </div>
                ...
                <div class="col-sm-4 col-xs-12" >
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body" style="text-align:left;">
                        ...
                        <p style="color:black;">2.處理器: Intel® iCore™ i5-3570K or AMD® Ryzen™ 5 2400G</p><br />
                        <p style="color:black;">3.記憶體: 4 GB 記憶體</p><br />
                        <p style="color:black;">4.儲存空間: 10 GB 可用空間</p>
                    </div>
                    <div class="panel-footer">
