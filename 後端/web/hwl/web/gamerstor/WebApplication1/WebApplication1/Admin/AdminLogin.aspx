...
<body>
    <form id="form1" runat="server">
            ...
            <div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
              <button class="w3-bar-item w3-button w3-hide-large w3-hover-none w3-hover-text-light-grey" onclick="w3_open();"><i class="fa fa-bars"></i>選單</button>
              <a href="../Index_meun/WebStore.aspx"><span class="w3-bar-item w3-right">Delight</span></a>
            ...
            <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
              <div class="w3-container w3-row">
                ...
                <div class="w3-col s8 w3-bar">
                  <span>Welcome, </span><asp:Label ID="Viewname" runat="server" Text=""  ForeColor="black"/><br/>
