<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="registerAdmin.aspx.vb" Inherits="WebApplication1.registerAdmin" %>
...
<body>
    ...
    <div class="loginbox" style="height:800px; " >
        ...
        <div class="nav-bax" >
                <p>SID</p>
                <asp:TextBox ID="txtSid"  type="birthday" runat="server" name="" placeholder="輸入SID"></asp:TextBox>
