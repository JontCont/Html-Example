<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Store5.aspx.vb" Inherits="WebApplication1.Store5" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Delight - Tom Clancy's Rainbow Six® Siege</title>
                                 ...
                                 <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                       ...
                                       <div class="carousel-inner">
                                              <div class="item active">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/359550/ss_891ce71ba6b2640270589687d58ef3be4b8fe044.1920x1080.jpg?t=1558096774" alt="Los Angeles" style="width:100%;"/>
                                              </div>

                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/359550/ss_f8b0572f49f5a25ddb2200d3fb5277ebabd482eb.1920x1080.jpg?t=1558096774" alt="Chicago" style="width:100%;"/>
                                              </div>
                                       
                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/359550/ss_d111995cdafd7fac5bdbe62e428756e5dae0877c.1920x1080.jpg?t=1558096774" alt="New york" style="width:100%;"/>
                                              </div>
                                       </div>
                                  ...
                                  <div class="col-sm-5" style="left:5%;top:10px;">
                                      <img style="height:150px;" src="https://steamcdn-a.akamaihd.net/steam/apps/359550/header.jpg?t=1558096774"/>
                                      <p style="font-size:14px; width:85%;">
                                         《湯姆克蘭西之虹彩六號：圍攻行動》是廣受好評的第一人稱射擊遊戲品牌最新系列作品，
                                          由知名開發團隊 Ubisoft 蒙特婁工作室所打造。</p>
                                      <p style="font-size:14px;"><br />&nbsp;發行日期:&nbsp;2015 年 12 月 2 日</p>
                                      <p style="font-size:14px;">&nbsp;發行商:&nbsp;Ubisofti</p>
                ...
                <div class="col-sm-4 col-xs-12" style="height:390px;">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"style="text-align:left;">
                      <p style="color:black;">名稱:  Tom Clancy's Rainbow Six® Siege</p>
                      <p style="color:black;">類型: 動作</p>
                      <p style="color:black;">開發人員: Ubisoft Montreals</p>
                      <p style="color:black;">發行商: Ubisoft</p>
                      <p style="color:black;">系列作: none</p>
                      <p style="color:black;">發行日期: 2015 年 12 月 2 日</p>
                    </div>
                ...
                <div class="col-sm-4 col-xs-12" >
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body" style="text-align:left;">
                        ...
                        <p style="color:black;">2.處理器: ntel Core i5-2500K @ 3.3 GHz or better or AMD FX-8120 @ 3.1 Ghz or better</p><br />
                        <p style="color:black;">3.記憶體: 8 GB 記憶體</p><br />
                        <p style="color:black;">4.儲存空間: 61 GB 可用空間</p>
                    </div>
