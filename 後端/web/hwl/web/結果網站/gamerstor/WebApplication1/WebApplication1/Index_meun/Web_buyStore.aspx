<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="Web_buyStore.aspx.vb" Inherits="WebApplication1.WebbuyStor" %>
            ...
            <div class="col-md-12">
                   <div class ="auto-style4">                     
                     <asp:Panel ID="Panel1" runat="server" style="position: relative; float: right; ">
                         ...
                         <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/logo_01.jpg" CssClass="auto-style3" Height="58px" Width="224px" PostBackUrl="~/Index_meun/WebStore.aspx" />                <!--******************menu*****************-->
                       <!--******************menu*****************-->
                <nav class ="navbar">
                    <div class="dropdown" id="dropdownMenuLink" >
                        <asp:button ID="Button4" runat="server" class="dropbtn"  PostBackUrl="~/Index_meun/Web_buyStore.aspx" Text="商店"/>
