...
//取得資料
Vector<TableRecord> cps = app_sm.selectAll(tblcp, 
		"cp_code=? and cp_lang=? and cp_display=?", 
...
Vector<TableRecord> aps = app_sm.selectAll(tblap, 
		"ap_lang=? and ap_code=?AND (? BETWEEN DATE_FORMAT(ap_emitdate,'%Y/%m/%d') and DATE_FORMAT(ap_restdate,'%Y/%m/%d'))",
		new Object[]{lang, "school_banner", app_today},"ap_showseq ASC , ap_createdate DESC limit 5");
