			...
			<div class="right">
				...
				<div class="NewsListArea">
					...
					<div class="NewsList">
						...
						<div class="NL_tit">
							<a href="../news/volunteer_in.jsp?no=<%=np.getString("np_id")%>" title="<%=AppConfig.getProperty("openLink."+lang) %><%=np.getString("np_no").trim().equals("") ? "" : "(" + np.getString("np_no") + ")"%><%=np.getString("np_title")%>">
