			...
			<div class="right">
				...
				<div class="NewsListArea">
					...
					<div class="NewsList">
						...
						<div class="NL_tit">
							<a href="../service/event_in.jsp?no=<%=np.getString("np_id")%>" title="前往<%=np.getString("np_no").trim().equals("") ? "" : "(" + np.getString("np_no") + ")"%><%=np.getString("np_title")%>">
