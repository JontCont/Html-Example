		...
		<div class="wrap">
			...
			<div class="right">
				...
				<div class="topListArea">
					...
					<div class="tLA_list<%=cp.getString("cp_id").equals(cp_no.getString("cp_id"))?" active":""%>">
						<a href="../service/employer.jsp?no=<%=cp.getString("cp_id") %>" title="<%=AppConfig.getProperty("openLink."+lang) %><%=cp.getString("cp_title")%>">
