					...
					<div class="squareList">
						...
						<div class="sLl_img book">
							<a href="<%=bd.getString("bd_url")%>" target="_blank" title="<%=bd.getString("bd_alt")%>">
								<img src="<%=app_fetchpath + "/sound/" + lang + "/" + bd.getString("bd_image")%>" alt="<%=bd.getString("bd_alt")%>" title="<%=bd.getString("bd_alt")%>" />
							</a>
						</div>
						...
						<div class="sLl_item">
							<%--
							<div class="sLli_tit"><%=show_str.get("desc."+lang) %>：</div>
							 --%>
							<div class="sLli_content">
								<span>
