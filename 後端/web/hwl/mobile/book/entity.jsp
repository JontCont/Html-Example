				...
				<div class="squareListArea">
					...
					<div class="squareList">
						<div class="sLl_tit book">
							<a href="../book/entity_in.jsp?no=<%=bd.getString("bd_id") %>" title="<%=AppConfig.getProperty("openLink."+lang) %><%=bd.getString("bd_title")%>">
								<%=bd.getString("bd_title")%>
							</a>
						</div>
						<div class="sLl_img book">
							<a href="../book/entity_in.jsp?no=<%=bd.getString("bd_id") %>" title="<%=bd.getString("bd_alt")%>">
								<img src="<%=app_fetchpath + "/entity/" + lang + "/" + bd.getString("bd_image")%>" alt="<%=bd.getString("bd_alt")%>" title="<%=bd.getString("bd_alt")%>" />
							</a>
						</div>						
						...
						<% } %>
						<% if(bd.getString("bd_format_display").equals("Y")){ %>
						<div class="sLl_item">
