<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Store6.aspx.vb" Inherits="WebApplication1.Store6" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Delight - Counter-Strike: Global Offensive</title>
                                 ...
                                 <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                       ...
                                       <div class="carousel-inner">
                                              <div class="item active">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/730/ss_1d30c9a215fd621e2fd74f40d93b71587bf6409c.1920x1080.jpg?t=1554409309" alt="Los Angeles" style="width:100%;"/>
                                              </div>

                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/730/ss_baa02e979cd3852e3c4182afcd603ab64e3502f9.1920x1080.jpg?t=1554409309" alt="Chicago" style="width:100%;"/>
                                              </div>
                                       
                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/730/ss_9db552fd461722f1569e3292d8f2ea654c8ffdef.1920x1080.jpg?t=1554409309" alt="New york" style="width:100%;"/>
                                              </div>
                                       </div>
                                  ...
                                  <div class="col-sm-5" style="left:5%;top:10px;">
                                      <img style="height:150px;" src="https://steamcdn-a.akamaihd.net/steam/apps/730/header.jpg?t=1554409309"/>
                                      <p style="font-size:14px; width:85%;">
                                            《絕對武力：全球攻勢》（CS: GO）延續了 1999 年原作在團隊競技類遊戲上取得的傲人成就。 
                                          CS: GO 包含了全新地圖、人物、武器、全新的遊戲模式，並提供了新版的 CS 經典內容（de_dust2 等地圖）。</p>
                                      <p style="font-size:14px;"><br />&nbsp;發行日期:&nbsp;2012 年 8 月 22 日</p>
                                      <p style="font-size:14px;">&nbsp;發行商:&nbsp;Valve</p>
                ...
                <div class="col-sm-4 col-xs-12" style="height:390px;">
                  <div class="panel panel-default text-center">
                    <div class="panel-heading">
                      <h1>購買 Counter-Strike: Global Offensive</h1>
                    </div>
                    <div class="panel-body"style="text-align:left;">
                      <p style="color:black;">名稱: Counter-Strike: Global Offensive</p>
                      <p style="color:black;">類型: 動作</p>
                      <p style="color:black;">開發人員: Valve, Hidden Path Entertainment</p>
                      <p style="color:black;">發行商: Valve</p>
                      <p style="color:black;">系列作: none</p>
                      <p style="color:black;">發行日期: 2012 年 8 月 22 日</p>
                    </div>
                ...
                <div class="col-sm-4 col-xs-12" >
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body" style="text-align:left;">
                        ...
                        <p style="color:black;">2.處理器: Intel® Core™ 2 Duo E6600 or AMD Phenom™ X3 8750 processor or better</p><br />
                        <p style="color:black;">3.記憶體: 2 GB 記憶體</p><br />
                        <p style="color:black;">4.儲存空間: 15  GB 可用空間</p><br />
                    </div>
                    <div class="panel-footer">
