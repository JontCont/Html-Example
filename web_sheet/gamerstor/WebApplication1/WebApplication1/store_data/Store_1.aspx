<%@ Page Language="vb"  AutoEventWireup="true" CodeBehind="Store_1.aspx.vb" Inherits="WebApplication1.Store_1"%>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Delight - Blood: Fresh Supply™</title>
                              ...
                              <div class="col-sm-8">
                                 <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                       ...
                                       <div class="carousel-inner">
                                              <div class="item active">
                                                <img src="https://i.ytimg.com/vi/2V_BcrpQQ1Y/maxresdefault.jpg" alt="Los Angeles" style="width:100%;"/>
                                              </div>

                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/1010750/ss_2123e73fccf5d8e7ec4bafc92cf9c77386954be5.1920x1080.jpg?t=1557421179" alt="Chicago" style="width:100%;"/>
                                              </div>
                                       
                                              <div class="item">
                                                <img src="https://steamcdn-a.akamaihd.net/steam/apps/1010750/ss_784f6ff8f0e07b2922c6464bb8a226c17b09dfb9.1920x1080.jpg?t=1557421179" alt="New york" style="width:100%;"/>
                                              </div>
                                       </div>
                                ...
                                <br />
                                  <div class="col-sm-5" style="left:5%;top:10px;">
                                      <img style="height:150px;" src="https://steamcdn-a.akamaihd.net/steam/apps/1010750/header.jpg?t=1557421179"/>
                                      ...
                                      <p style="font-size:14px;"><br />&nbsp;發行日期:&nbsp;2019 年 5 月 10 日</p>
                                      <p style="font-size:14px;">&nbsp;發行商:&nbsp;Nightdive Studios, Atari</p>
                                      <p style="font-size:14px;">&nbsp;類型:&nbsp;MUD</p>
                                  </div>
                        </div>
                     </div><!--row--><br />
                    <br />
              ...
              <div class="row slideanim">
                ...
                <div class="col-sm-4 col-xs-12" style="height:390px;">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"style="text-align:left;">
                      <p style="color:black;">名稱: Blood: Fresh Supply™</p>
                      <p style="color:black;">類型: 動作</p>
                      <p style="color:black;">開發人員: Nightdive Studios, Monolith Productions</p>
                      <p style="color:black;">發行商: Nightdive Studios, Atari</p>
                      <p style="color:black;">系列作: Blood</p>
                      <p style="color:black;">發行日期: 2019 年 5 月 10 日</p>
                    </div>
                ...
                <div class="col-sm-4 col-xs-12" >
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body" style="text-align:left;">
                        ...
                        <p style="color:black;">2.處理器: Intel Core i5-2300 2.8 GHz/AMD Phenom II X4 945 3.0 GHz or equivalent</p>
                        <p style="color:black;">3.記憶體: 2 GB 記憶體</p>
                        <p style="color:black;">4.儲存空間: 1 GB 可用空間</p>
                        <br />
                        <br />
                        <br />
                    </div>
                ...
                <div class="col-sm-4 col-xs-12" style="height:390px;">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body" style="text-align:left;">
                       <p style="color:black;">1.Updated using Nightdive Studio’s KEX Engine</p><br />
                       <p style="color:black;">2.Vulkan, DirectX 11 and OpenGL 3.2 support, play with unlocked framerates!</p><br />
                       <p style="color:black;">3.Antialiasing, Ambient Occlusion, V-sync and Interpolation support</p>
