...
<div class="container-fluid bg-2 text-center">
  ...
  <p>您需要什麼協助？ <br/>登入您的 Delight 帳戶來檢視購買與帳戶狀態，並獲取個人化的幫助。</p><br/>
      <asp:button ID="Button8" runat="server" type="button" class="btn btn-primary btn-sm" style="font-size:15px;" Text="登入" PostBackUrl="~/Index_meun/WebSign_in.aspx"/>&nbsp;&nbsp;&nbsp;
       <asp:button ID="Button9" runat="server" type="button" class="btn btn-primary btn-sm" style="font-size:15px;" Text="無法登入"/>    
</div>
...
<div class="container-fluid bg-3 text-center">    
  <div class="row">
    ...
    <div class="col-sm-10">
        <button type="button" class="btn btn-primary btn-block">遊戲、軟體等</button><br/>
        <button type="button" class="btn btn-primary btn-block">購買消費</button><br/>
        <button type="button" class="btn btn-primary btn-block">我的帳戶</button><br/>
        <button type="button" class="btn btn-primary btn-block">社群、市集、贈禮</button><br/>
        <button type="button" class="btn btn-primary btn-block">我有來自 Steam 的不明扣款</button>
    </div>
